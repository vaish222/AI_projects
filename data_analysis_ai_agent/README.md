...
An AI-powered data analysis agent that generates executable Python code for exploratory data analysis using pandas, Matplotlib, and Seaborn, while delivering automated summary statistics and data-driven insights.
...
```bash
   uv add streamlit pandas matplotlib seaborn langchain langchain-ollama
```
